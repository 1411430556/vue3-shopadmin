      ...
      <el-tabs v-model="activeName">
        <el-tab-pane label="注册与访问" name="first">
          ...
          <el-form-item label="密码最小长度">
            <el-input v-model="form.password_min" placeholder="密码最小长度" style="width: 20%;" type="number"/>
          </el-form-item>
        ...
        <el-tab-pane label="上传设置" name="second">
          ...
          <el-form-item label="Bucket">
            <el-input v-model="form.upload_config.Bucket" placeholder="Bucket" style="width: 20%;"/>
          </el-form-item>
          <el-form-item label="ACCESS_KEY">
            <el-input v-model="form.upload_config.ACCESS_KEY" placeholder="ACCESS_KEY" style="width: 20%;"/>
          </el-form-item>
          <el-form-item label="SECRET_KEY">
            <el-input v-model="form.upload_config.SECRET_KEY" placeholder="SECRET_KEY" style="width: 20%;"/>
          </el-form-item>
          <el-form-item label="空间域名">
            <el-input v-model="form.upload_config.http" placeholder="空间域名" style="width: 20%;"/>
            <el-tag class="ml-2" type="info">请补全http:// 或 https://</el-tag>
          </el-form-item>
        </el-tab-pane>
        <el-tab-pane label="API安全" name="third">
          <el-form-item label="是否开启API安全">
            ...
            <el-tag class="ml-2" type="info">api安全功能开启之后调用前端api需要传输签名串</el-tag>
          </el-form-item>
          <el-form-item label="秘钥">
            <el-input v-model="form.api_secret" placeholder="秘钥" style="width: 20%;"/>
